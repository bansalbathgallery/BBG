...
let modules = [
  ...
  require('./textMessages'),
  require('./chef'), 
  require('./features'), 
  require('./companyTypes'), 
  require('./serviceRatings'),
  require('./userCoupons'),
  require('./companyCuisines'),
  require('./userCards'),
  require('./menus'),
  require('./companyTimings'),
  require('./CompanyDocuments'),
  require('./CompanyImages'),
  require('./groupMembers'),
  require('./groups'),
  require('./mediaMessages.js'),
  require('./messagesStatus.js'),
  require('./CompanyVideos'),
  require('./vehicle'),
  require('./vehicleType'),
  require('./settings'),
  require('./earnings'),
