  ...
  */
  list: async (req, res, next) => {
    try{
      ...
      return res.render(superadminfilepath+'riders/list.ejs',{data:findData});
    } catch (e) {
  ...
  */
  requestlist: async (req, res, next) => {
    try {
      ...
      return res.render(superadminfilepath+'riders/requests.ejs',{data:findData});
    } catch (e) {
      return responseHelper.error(res, e.message, 400);
    }
  },
  ...
  */
  details: async(req,res,next) => { 
    try{
      ...
      return res.render(superadminfilepath+'riders/view.ejs',{userData,vehices});
    }catch (e) {
